...
// found on file: lbneEVDraw35t_tree_Cosmic_1000evt.root
//////////////////////////////////////////////////////////
...
//   MakeHistograms(TTree *tree=0);
   MakeHistograms(std::string dfname="lbneEVDraw35t_tree_Cosmic_1000evt.root");
...
//	fCanvas = new TCanvas("Ecanvas","LBNE 35t detector event display",800,600);
   Init(tree);
	HistDef();
}
