...
void MakeHistograms::PrintHistos() {
	TCanvas *c1 = new TCanvas("c1","LBNE 35t detector event display",800,600);
...
void MakeHistograms::PrintGraphs(std::vector<TH2I*> h) {
	TCanvas *c2 = new TCanvas("c2","LBNE 35t detector event display",800,600);
...
void MakeHistograms::DrawUplane() {
	...
	fCanvas = new TCanvas("Ecanvas","LBNE 35t detector event display",700,700);
