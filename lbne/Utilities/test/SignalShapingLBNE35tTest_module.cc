//
// Name:  SignalShapingLBNE35tTest.h
//
// Purpose: SignalShapingLBNE35tTest module.  Test convolution/deconvolution.
//
...
namespace util
{
  class SignalShapingLBNE35tTest : public art::EDAnalyzer
  {
  public:

    // Constructor, destructor.

    explicit SignalShapingLBNE35tTest(fhicl::ParameterSet const& pset);
    virtual ~SignalShapingLBNE35tTest();
  ...
  SignalShapingLBNE35tTest::~SignalShapingLBNE35tTest()
  {}

  void SignalShapingLBNE35tTest::analyze(const art::Event& evt)
 {}
}
