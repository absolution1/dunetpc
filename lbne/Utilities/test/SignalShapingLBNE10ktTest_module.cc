//
// Name:  SignalShapingLBNE10ktTest.h
//
// Purpose: SignalShapingLBNE10ktTest module.  Test convolution/deconvolution.
//
...
namespace util
{
  class SignalShapingLBNE10ktTest : public art::EDAnalyzer
  {
  public:

    // Constructor, destructor.

    explicit SignalShapingLBNE10ktTest(fhicl::ParameterSet const& pset);
    virtual ~SignalShapingLBNE10ktTest();
  ...
  DEFINE_ART_MODULE(SignalShapingLBNE10ktTest);

  SignalShapingLBNE10ktTest::SignalShapingLBNE10ktTest(const fhicl::ParameterSet& pset)
  {}

  void SignalShapingLBNE10ktTest::beginJob()
  {
    // Get services.
  ...
  SignalShapingLBNE10ktTest::~SignalShapingLBNE10ktTest()
  {}

  void SignalShapingLBNE10ktTest::analyze(const art::Event& evt)
 {}
}
