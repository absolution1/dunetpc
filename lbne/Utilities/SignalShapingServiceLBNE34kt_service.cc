////////////////////////////////////////////////////////////////////////
/// \file   SignalShapingServiceLBNE34kt_service.cc
/// \author H. Greenlee 
////////////////////////////////////////////////////////////////////////

#include "lbne/Utilities/SignalShapingServiceLBNE34kt.h"
...
//----------------------------------------------------------------------
// Constructor.
util::SignalShapingServiceLBNE34kt::SignalShapingServiceLBNE34kt(const fhicl::ParameterSet& pset,
...
//----------------------------------------------------------------------
// Destructor.
util::SignalShapingServiceLBNE34kt::~SignalShapingServiceLBNE34kt()
{}


//----------------------------------------------------------------------
// Reconfigure method.
void util::SignalShapingServiceLBNE34kt::reconfigure(const fhicl::ParameterSet& pset)
{
 ...
 {
  mf::LogInfo("SignalShapingServiceLBNE34kt") << "Getting Filter from .fcl file";
...
util::SignalShapingServiceLBNE34kt::SignalShaping(unsigned int channel) const
{
  if(!fInit)
    init();
...
void util::SignalShapingServiceLBNE34kt::init()
{
  if(!fInit) {
    fInit = true;
...
void util::SignalShapingServiceLBNE34kt::SetFieldResponse()
{
  // Get services.
...
void util::SignalShapingServiceLBNE34kt::SetElectResponse(double shapingtime, double gain)
{
  ...
  LOG_DEBUG("SignalShapingLBNE34kt") << "Setting LBNE34kt electronics response function...";
...
void util::SignalShapingServiceLBNE34kt::SetFilters()
{
  // Get services.
