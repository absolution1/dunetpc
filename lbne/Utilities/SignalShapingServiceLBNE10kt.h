///////////////////////////////////////////////////////////////////////
///
/// \file   SignalShapingServiceLBNE10kt.h
///
...
#ifndef SIGNALSHAPINGSERVICELBNE10KT_H
#define SIGNALSHAPINGSERVICELBNE10KT_H
...
namespace util {
  ...
  public:
    ...
    SignalShapingServiceLBNE10kt(const fhicl::ParameterSet& pset,
				   art::ActivityRegistry& reg);
    ~SignalShapingServiceLBNE10kt();
  ...
  private:
    ...
    void init() const{const_cast<SignalShapingServiceLBNE10kt*>(this)->init();}
    void init();
...
//----------------------------------------------------------------------
// Do convolution.
template <class T> inline void util::SignalShapingServiceLBNE10kt::Convolute(unsigned int channel, std::vector<T>& func) const
{
...
//----------------------------------------------------------------------
// Do deconvolution.
template <class T> inline void util::SignalShapingServiceLBNE10kt::Deconvolute(unsigned int channel, std::vector<T>& func) const
{
