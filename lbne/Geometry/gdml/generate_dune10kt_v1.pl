...
# and open it
    $DEF = "dune10kt_v1_Def" . $suffix . ".gdml";
    push (@gdmlFiles, $DEF);
    $DEF = ">" . $DEF;
...
# and open it
    $MAT = "dune10kt_v1_Materials" . $suffix . ".gdml";
    push (@gdmlFiles, $MAT);
    $MAT = ">" . $MAT;
...
# add file to list of output GDML fragments,
# and open it
    $TPC = "dune10kt_v1_TPC_${_[3]}" . $suffix . ".gdml";
    push (@gdmlFiles, $TPC);
    $TPC = ">" . $TPC;
...
# add file to list of output GDML fragments,
# and open it
    $CRYO = "dune10kt_v1_Cryostat" . $suffix . ".gdml";
    push (@gdmlFiles, $CRYO);
    $CRYO = ">" . $CRYO;
...
# add file to list of output GDML fragments,
# and open it
    $ENCL = "dune10kt_v1_DetEnclosure" . $suffix . ".gdml";
    push (@gdmlFiles, $ENCL);
    $ENCL = ">" . $ENCL;
...
# add file to list of output GDML fragments,
# and open it
    $WORLD = "dune10kt_v1_World" . $suffix . ".gdml";
