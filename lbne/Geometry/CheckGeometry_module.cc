...
class lbne::CheckGeometry : public art::EDAnalyzer {
public:
...
lbne::CheckGeometry::CheckGeometry(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p)
{
  reconfigure(p);
...
void lbne::CheckGeometry::analyze(art::Event const & evt)
{
...
void lbne::CheckGeometry::reconfigure(fhicl::ParameterSet const & p)
{
  // Implementation of optional member function here.
}

DEFINE_ART_MODULE(lbne::CheckGeometry)
