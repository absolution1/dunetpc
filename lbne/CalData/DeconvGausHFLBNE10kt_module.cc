#ifndef DECONVGAUSHFLBNE10KT_H
#define DECONVGAUSHFLBNE10KT_H

////////////////////////////////////////////////////////////////////////
//
// DeconvGausHFLBNE10kt class
//
// jti3@fnal.gov
//
...
namespace deconvgaushf {
  ...
  class DeconvGausHFLBNE10kt : public art::EDProducer {

  public:
    
    // create calibrated signals on wires. this class runs 
    // an fft to remove the electronics shaping.     
    explicit DeconvGausHFLBNE10kt(fhicl::ParameterSet const& pset); 
    virtual ~DeconvGausHFLBNE10kt();
  ...
  //-------------------------------------------------
  DeconvGausHFLBNE10kt::~DeconvGausHFLBNE10kt()
  {
  }

  //////////////////////////////////////////////////////
  void DeconvGausHFLBNE10kt::reconfigure(fhicl::ParameterSet const& p)
  {
  ...
  //-------------------------------------------------
  void DeconvGausHFLBNE10kt::beginJob()
  {  
  }

  //////////////////////////////////////////////////////
  void DeconvGausHFLBNE10kt::endJob()
  {  
  }
  
  //////////////////////////////////////////////////////
  void DeconvGausHFLBNE10kt::produce(art::Event& evt)
  {      
    // get the geometry
    ...
    mf::LogInfo("DeconvGausHFLBNE10kt") << "DeconvGausHFLBNE10kt:: digitVecHandle size is " << digitVecHandle->size();
	...
	for(bin=0; bin < (unsigned int)fPostsample; ++bin) 
      ...
      //if(wirecol->size() == 0)
      //mf::LogWarning("DeconvGausHFLBNE10kt") << "No wires made for this event.";
