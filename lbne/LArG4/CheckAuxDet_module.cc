...
class lbne::CheckAuxDet : public art::EDAnalyzer {
public:
...
lbne::CheckAuxDet::CheckAuxDet(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p),
  fLArG4ModuleLabel(p.get< std::string >("LArGeantModuleLabel", "largeant"))
{}

void lbne::CheckAuxDet::analyze(art::Event const & evt)
{
  ResetVars();
...
void lbne::CheckAuxDet::beginJob()
{
...
void lbne::CheckAuxDet::reconfigure(fhicl::ParameterSet const & p)
{
  // Implementation of optional member function here.
}

void lbne::CheckAuxDet::ResetVars(){
...
DEFINE_ART_MODULE(lbne::CheckAuxDet)
