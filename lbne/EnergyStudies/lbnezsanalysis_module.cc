...
#ifndef lbnezsanalysis_Module
#define lbnezsanalysis_Module
...
namespace lbnezsanalysis {

  //-----------------------------------------------------------------------
  //-----------------------------------------------------------------------
  // class definition

  class lbnezsanalysis : public art::EDAnalyzer 
  {
  public:
 
    // Standard constructor and destructor for an ART module.
    explicit lbnezsanalysis(fhicl::ParameterSet const& pset);
    virtual ~lbnezsanalysis();
  ...
  //-----------------------------------------------------------------------
  // Constructor
  lbnezsanalysis::lbnezsanalysis(fhicl::ParameterSet const& parameterSet) : EDAnalyzer(parameterSet)
  {
  ...
  //-----------------------------------------------------------------------
  // Destructor
  lbnezsanalysis::~lbnezsanalysis() 
  {}
   
  //-----------------------------------------------------------------------
  void lbnezsanalysis::beginJob()
  {
    ...
    fReconstructionNtuple = tfs->make<TTree>("lbnezsanalysisReconstruction","lbnezsanalysisReconstruction");
  ...
  //-----------------------------------------------------------------------
  void lbnezsanalysis::analyze(const art::Event& event) 
  {
  ...
  // .fcl file; see lbnezsanalysis.fcl for more information.
  DEFINE_ART_MODULE(lbnezsanalysis)

    } // namespace lbnezsanalysis

#endif // lbnezsanalysis_Module
