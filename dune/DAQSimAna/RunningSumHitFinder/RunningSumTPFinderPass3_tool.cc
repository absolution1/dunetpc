////////////////////////////////////////////////////////////////////////
// Class:       RunningSumTPFinderPass3
// Plugin Type: service (art v2_10_03)
// File:        RunningSumTPFinderPass3_service.cc
//
// Generated at Tue Jun  5 07:51:38 2018 by Philip Rodrigues using cetskelgen
// from cetlib version v3_02_00.
////////////////////////////////////////////////////////////////////////

#include "dune/DAQSimAna/RunningSumHitFinder/RunningSumTPFinderPass3.h"
...
std::vector<short> RunningSumTPFinderPass3::downSample(const std::vector<short>& orig) {
...
std::vector<short> RunningSumTPFinderPass3::findPedestal(const std::vector<short>& waveform)
{
  //---------------------------------------------
...
std::vector<short> RunningSumTPFinderPass3::filter(const std::vector<short>& pedsub) {
...
std::vector<short> RunningSumTPFinderPass3::runSum(const std::vector<short>& filtered) {
...
void
RunningSumTPFinderPass3::hitFinding(const std::vector<short>& waveform,
...
RunningSumTPFinderPass3::findHits(const std::vector<unsigned int>& channel_numbers, 
  ...
  for(size_t ich=0; ich<collection_samples.size(); ++ich){
    ...
    hitFinding(runingSum, iqr, hits, channel_numbers[ich]);
  }
...
DEFINE_ART_CLASS_TOOL(RunningSumTPFinderPass3)
