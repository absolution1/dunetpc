...
namespace EventRecord {
  ...
  class HitContributor {
    /*ClassDef(EventRecord::HitContributor,10);*/
    public:
...
/*  class TrackRecord {
  ...
  class ParticleRecord  {
    /*ClassDef(EventRecord::ParticleRecord,10);*/
    public:
      bool isEve;
  ...
  class EveRecord{
    /*ClassDef(EventRecord::EveRecord,10);*/
    public:
      //eve_number_t number;
      Int_t trackId;
      UInt_t pdgid;
  ...
  class EventRecord {
    /*ClassDef(EventRecord::EventRecord,10);*/
    public:
      bool bunch_hits;
      UInt_t run;
      UInt_t subrun;
