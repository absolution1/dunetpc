////////////////////////////////////////////////////////////////////////
// \file    RegCVNEventDump_module.cc
// \brief   Analyzer module for creating RegCVN PixelMap objects modified from CVNEventDump_module.cc
...
namespace cvn {
  class RegCVNEventDump : public art::EDAnalyzer {
  public:

    explicit RegCVNEventDump(fhicl::ParameterSet const& pset);
    ~RegCVNEventDump();
  ...
  //.......................................................................
  RegCVNEventDump::RegCVNEventDump(fhicl::ParameterSet const& pset)
    : EDAnalyzer(pset)
  {
  ...
  //......................................................................
  RegCVNEventDump::~RegCVNEventDump()
  {  }

  //......................................................................
  void RegCVNEventDump::reconfigure(const fhicl::ParameterSet& pset)
  {
  ...
  //......................................................................
  void RegCVNEventDump::beginJob()
  {

  }

  //......................................................................
  void RegCVNEventDump::endJob()
  {

  }

  //......................................................................
  void RegCVNEventDump::analyze(const art::Event& evt)
  {
  ...
  void RegCVNEventDump::WriteMapTH2(const art::Event& evt, int slice, const RegPixelMap& pm)
  {
...
DEFINE_ART_MODULE(cvn::RegCVNEventDump)
} // end namespace cvn
////////////////////////////////////////////////////////////////////////
