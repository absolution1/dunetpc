...
#ifndef PDSPTPCDataInterfaceParent_H
#define PDSPTPCDataInterfaceParent_H
...
public:
  ...
  virtual int retrieveDataForSpecifiedAPAs(
    art::Event &evt, std::vector<raw::RawDigit> &raw_digits, std::vector<raw::RDTimeStamp> &rd_timestamps,
    art::Assns<raw::RawDigit,raw::RDTimeStamp> rd_ts_assocs, std::vector<raw::RDStatus> &rdstatuses, std::string outputLabel, 
    std::vector<int> &apalist) = 0;
