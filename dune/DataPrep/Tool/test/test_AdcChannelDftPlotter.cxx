...
int test_AdcChannelDftPlotter(bool useExistingFcl =false) {
  ...
  if ( ! useExistingFcl ) {
    ...
    fout << "tools.mypwr.HistName: \"hdftpower_run%RUN%_evt%EVENT%\"" << endl;
    fout << "tools.mypwr.HistTitle: \"DFT power for run %RUN% event %EVENT%\"" << endl;
    fout << "tools.mypwr.PlotName: \"dftpower_run%RUN%_evt%EVENT%_ch%CHAN%.png\"" << endl;
    fout << "" << endl;
    ...
    fout << "tools.mypwt.HistName: \"hdftpowt_run%RUN%_evt%EVENT%\"" << endl;
    fout << "tools.mypwt.HistTitle: \"DFT power for run %RUN% event %EVENT% channel %CHAN%\"" << endl;
    fout << "tools.mypwt.PlotName: \"dftpowt_run%RUN%_evt%EVENT%_ch%CHAN%.png\"" << endl;
    fout.close();
  } else {
